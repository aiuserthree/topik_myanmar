...
> **DB 엔진**: PostgreSQL 15+ 권장 (MySQL 8 동등 매핑 가능). 마이그레이션 도구·호스트는 **미확정** — 본 문서는 논리 스키마만 정의.
...
| NO | 항목 | 본 문서 |
| ---: | --- | --- |
| 158 | Flyway/Liquibase 선택 | 권장만, 미구현 |
| 159 | 시드 데이터 SQL | 테이블 목록만 |
| 160–161 | 백업·트랜잭션 정책 | 인프라 문서 대상 |
...
**참고 문서**: `기능정의서/FO/04_TOPIK접수_기능정의서.md`, `기능정의서/BO/02_접수관리_기능정의서.md`, `기능정의서/BO/03_시험관리_기능정의서.md`, `html/shared/topik-bo-core.js`, `build.py` (A안→public, shared 복사).
