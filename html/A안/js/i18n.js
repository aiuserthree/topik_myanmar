(function () {
  ...
  var dict = {
    ko: {
      nav_menu_guide: "TOPIK 안내",
      nav_menu_rules: "TOPIK 규정",
      nav_menu_register: "TOPIK 접수",
      nav_menu_board: "게시판",
      sub_guide_overview: "시험 개요",
      sub_guide_intro: "시험 소개",
      sub_guide_structure: "문항 구성",
      sub_guide_grading: "평가 기준",
      sub_rules_caution: "유의 사항",
      sub_rules_answer: "답안 작성 요령",
      sub_rules_fee: "응시료 규정",
      sub_rules_id: "신분증 규정",
      sub_reg_howto: "접수 방법",
      sub_reg_apply: "시험 접수",
      sub_reg_confirm: "접수 확인",
      sub_reg_ticket: "수험표 출력",
      sub_board_notice: "공지사항",
      sub_board_refund: "환불·정보정정신청",
      sub_board_inquiry: "문의게시판",
      sub_board_faq: "FAQ",
      nav_guide: "TOPIK 안내",
      nav_rules: "TOPIK 규정",
      nav_register: "시험 접수",
      ...
      tab_notice: "공지",
      tab_mypage: "마이",
      hero_badge: "제107회 한국어능력시험 (2026.10.18)",
      ...
      cd_min: "분",
      cd_sec: "초",
      cd_period: "접수기간: 2026.07.17 ~ 2026.07.21 · 응시료 수납 07.24~26",
      sec_notice: "공지사항",
      sec_notice_more: "더보기",
      sec_schedule: "시험 일정",
      sec_quick: "바로가기",
      ...
      lookup_desc: "접수 시 입력한 영문 성명과 생년월일로 수험번호를 확인합니다. (데모: 번호 부여됨 MA THIDA/19950315 · 미부여 PARK MINJU/19981225)",
      lbl_fullname: "영문 성명 (여권과 동일)",
      lbl_birth: "생년월일",
      btn_search: "수험번호 조회",
      err_empty: "이름과 생년월일을 입력해 주세요.",
      msg_notfound: "일치하는 응시 정보가 없습니다. 이름·생년월일·수납 완료 여부를 확인하거나 마이페이지를 이용해 주세요.",
      lookup_pending_lead: "접수 정보는 확인되었으나, 수험번호는 아직 부여되지 않았습니다. 수납 완료 후 관리자가 순차 부여하니 공지 일정을 확인하고 잠시 뒤 다시 조회해 주세요.",
      res_exam_pending: "미부여",
      res_exam: "수험번호",
      res_round: "회차",
      res_level: "급수",
      res_venue: "시험장",
    ...
    my: {
      nav_menu_guide: "TOPIK လမ်းညွှန်",
      nav_menu_rules: "TOPIK စည်းမျဉ်း",
      nav_menu_register: "TOPIK လျှောက်လွှာ",
      nav_menu_board: "ဖိုရမ်",
      sub_guide_overview: "စာမေးပွဲ အကျဉ်း",
      sub_guide_intro: "စာမေးပွဲ မိတ်ဆက်",
      sub_guide_structure: "မေးခွန်း ဖွဲ့စည်းပုံ",
      sub_guide_grading: "အဆင့်သတ်မှတ်",
      sub_rules_caution: "သတိပြုရန်",
      sub_rules_answer: "အဖြေရေးသားနည်း",
      sub_rules_fee: "စာမေးပွဲကြေး",
      sub_rules_id: "နိုင်ငံသားစိစစ်ရေးကတ်",
      sub_reg_howto: "လျှောက်နည်း",
      sub_reg_apply: "စာမေးပွဲ လျှောက်လွှာ",
      sub_reg_confirm: "လျှောက်ထားမှု စစ်ဆေး",
      sub_reg_ticket: "ဝင်ခွင့်လက်မှတ်",
      sub_board_notice: "ကြေညာချက်",
      sub_board_refund: "ငွေပြန်အမ်း·အချက်အလက်ပြင်ဆင်",
      sub_board_inquiry: "မေးမြန်းချက်",
      sub_board_faq: "FAQ",
      nav_guide: "TOPIK လမ်းညွှန်",
      nav_rules: "TOPIK စည်းမျဉ်း",
      nav_register: "လျှောက်လွှာ",
      nav_mypage: "ကျွန်ုပ်၏စာမျက်နှာ",
      nav_notice: "ကြေညာချက်",
      nav_faq: "FAQ",
      nav_lookup: "စာမေးပွဲနံပါတ်",
      ...
      tab_notice: "ကြေညာ",
      tab_mypage: "ကျွန်ုပ်",
      hero_badge: "အကြိမ်(၁၀၇) ကိုရီးယား စာမေးပွဲ (2026.10.18)",
      ...
      cd_min: "မိနစ်",
      cd_sec: "စက္ကန့်",
      cd_period: "လျှောက်ကာလ 2026.07.17 ~ 07.21 · ကြေး 07.24~26",
      ...
      lookup_desc: "လျှောက်ထားသည့် အင်္ဂလိပ် အမည်နှင့် မွေးနေ့ ဖြည့်ပါ။ (ဒမို: ပါရှိပြီးသား MA THIDA/19950315 · မပါသေး PARK MINJU/19981225)",
      ...
      lookup_pending_lead: "လျှောက်လွှာ အချက်အလက်တို့ တွေ့ရှိပြီးသော်လည်း စာမေးပွဲနံပါတ်ကို မချိတ်ဆွဲရသေးပါ။ ပေးချေမှုပြီးပါက စီမံခန့်ခွဲသူက အစီအစဉ်အလိုက် ချိတ်ဆွဲသဖြင့် ကြေညာချက် အချိန်ဇယားကို စောင့်ပြီး ပြန်ရှာပါ။",
      res_exam_pending: "မပေးသင်္ကေတ",
    ...
    en: {
      nav_menu_guide: "About TOPIK",
      nav_menu_rules: "Exam rules",
      nav_menu_register: "Registration",
      nav_menu_board: "Board",
      sub_guide_overview: "Overview",
      sub_guide_intro: "Test introduction",
      sub_guide_structure: "Test structure",
      sub_guide_grading: "Scoring & grades",
      sub_rules_caution: "Important notes",
      sub_rules_answer: "Answer sheet guide",
      sub_rules_fee: "Fees & refund",
      sub_rules_id: "ID requirements",
      sub_reg_howto: "How to apply",
      sub_reg_apply: "Apply online",
      sub_reg_confirm: "Application status",
      sub_reg_ticket: "Admit card",
      sub_board_notice: "Notices",
      sub_board_refund: "Refund / correction",
      sub_board_inquiry: "Inquiry board",
      sub_board_faq: "FAQ",
      ...
      tab_notice: "News",
      tab_mypage: "My",
      hero_badge: "107th TOPIK (2026.10.18)",
      ...
      cd_min: "Min",
      cd_sec: "Sec",
      cd_period: "Period: 2026.07.17 ~ 07.21 · Fee payment 07.24~26",
      sec_notice: "Notices",
      ...
      lookup_desc: "Enter the English name and date of birth used at registration. (Demo: issued MA THIDA/19950315 · pending PARK MINJU/19981225)",
      ...
      lookup_pending_lead: "Your application was found, but an exam number has not been assigned yet. After payment is complete, numbers are assigned in order—please check the notice schedule and try again later.",
      res_exam_pending: "Not yet assigned",
