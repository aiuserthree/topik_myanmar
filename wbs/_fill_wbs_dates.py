"""
TOPIK Myanmar WBS 세부 개발 일정 — 4대 메뉴 구조(고객사 0519) 반영 재생성
================================================================
- 대상 파일: wbs/(아이뱅크) TOPIK_Myanmar_WBS 세부 개발 일정_v1.0.xlsx
- 전체 기간: 2026-05-20(수) ~ 2026-07-30(목)  (오픈일 2026-07-31)
- 단위테스트 5BD · 통합테스트 5BD
- FO-BO 연계 메뉴는 병행
...
WBS_PATH = REPO / "wbs" / "(아이뱅크) TOPIK_Myanmar_WBS 세부 개발 일정_v1.0.xlsx"
...
SCHEDULE: dict[str, tuple[tuple[int, int], ...]] = {
    ...
    "FO_COMMON":   ((5, 20), (5, 22), (6,  8), (6, 12), (7, 10), (7, 13)),
    # FO 홈
    "FO_HOME":     ((5, 25), (5, 27), (6, 15), (6, 19), (7, 10), (7, 13)),
    # FO TOPIK 안내 (시험 개요·소개·문항·평가)
    "FO_INFO":     ((5, 26), (5, 28), (6, 15), (6, 17), (7, 10), (7, 13)),
    # FO TOPIK 규정 (유의·답안·응시료·신분증)
    "FO_RULES":    ((5, 26), (5, 28), (6, 15), (6, 17), (7, 10), (7, 13)),
    # FO TOPIK 접수 (접수방법·시험접수·접수확인·수험표 출력)
    "FO_APPLY":    ((6,  1), (6,  9), (6, 22), (7,  3), (7, 13), (7, 16)),
    # FO 게시판 (공지·환불·정정·문의·FAQ)
    "FO_BOARD":    ((6,  3), (6,  9), (6, 22), (7,  2), (7, 13), (7, 16)),
    # FO 계정 (로그인·회원가입·내정보)
    "FO_ACCOUNT":  ((5, 25), (5, 29), (6, 15), (6, 24), (7, 13), (7, 15)),
    # FO 외부 링크
    "FO_EXTERNAL": ((6,  1), (6,  1), (6, 15), (6, 15), (7, 10), (7, 10)),

    # ────────── BO ──────────
    # BO 인증·공통 레이아웃
    "BO_AUTH":     ((5, 20), (5, 22), (6,  8), (6, 12), (7, 10), (7, 13)),
    # BO 대시보드
    "BO_DASH":     ((6,  3), (6,  5), (6, 29), (7,  2), (7, 15), (7, 16)),
    # BO 접수 관리 (접수자 목록 + 사진 심사 + 수험번호 + 엑셀 + 사진 zip)
    "BO_APPLY":    ((6,  1), (6,  9), (6, 22), (7,  3), (7, 13), (7, 16)),
    # BO 시험 관리 (회차 + 시험장 마스터)
    "BO_EXAM":     ((6,  3), (6,  9), (6, 29), (7,  3), (7, 14), (7, 16)),
    # BO 콘텐츠 (공지·FAQ·환불·정정·문의)
    "BO_CONTENT":  ((6,  4), (6, 10), (7,  1), (7,  8), (7, 14), (7, 16)),
    # BO 회원·약관
    "BO_MEMBER":   ((5, 27), (6,  2), (6, 15), (6, 26), (7, 13), (7, 15)),
    # BO 시스템 (관리자 계정·처리 이력·사이트 보기·로그아웃)
    "BO_SYSTEM":   ((5, 27), (6,  2), (6, 15), (6, 26), (7, 13), (7, 15)),
}

# 단위테스트·통합테스트
UNIT_TEST  = (D(2026, 7, 17), D(2026, 7, 23))
INTEG_TEST = (D(2026, 7, 24), D(2026, 7, 30))
